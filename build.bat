...
set SOURCES=src/main.cpp src/Core/Logger.cpp src/Hooks/HookManager.cpp src/Luau/LuauAPI.cpp src/Execution/ExecutionEngine.cpp src/Execution/EnvironmentManager.cpp src/IPC/PipeServer.cpp

...
| `src/Execution/EnvironmentManager.cpp` | Overrides print/warn/error, caches _G functions as JSON |
| `src/IPC/PipeServer.cpp` | Named pipe server — exec inbound thread + log outbound thread |
| `src/Luau/LuauAPI.cpp` | Resolves all Luau function pointers from Luau.VM.dll at runtime |
